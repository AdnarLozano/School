...
MONTH	LDI R1, X		;PUT ORIGINAL MONTH,x, IN R1
...
DIV1	LDI R0, NEWM		;LOAD VALUE OF NEWM IN R0
...
DIV2	LDI R0, D		;LOAD VALUE OF D, LAST 2 DIGITS OF YEAR, IN R0
	AND R1, R1, #0		;CLEARS R1
...
DIV3	LDI R0, C		;LOAD C, CENTURY OF YEAR, IN R0
	AND R1, R1, #0		;CLEARS R1
	ADD R1, R1, #4		;PUTS 4 IN R1
...
ZELLERS	LDI R0, K		;LOAD VALUE OF K, THE DAY ,IN R0
