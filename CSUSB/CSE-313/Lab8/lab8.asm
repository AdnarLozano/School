...
;Lab#8: Random Number Generator
	...
	ST R4, Q		;STORE VALUE OF R4 IN Q
	ST R5, R		;STORE VALUE OF R5 IN R
LOOP	LD R3, X		;LOAD X INTO R3
	LD R2, Q		;LOAD Q INTO Q
...
MLOOP	ADD R3, R3, R1
	ADD R2, R2, #-1
	BRp MLOOP		;REPEAT UNTIL NEG OR ZERO
	RET
DIV	ST R2, SAVE1
	ST R3, SAVE2
	AND R4, R4, x0
	NOT R2, R2		;2S COMPLIMENT OF R6
	ADD R2, R2, #1
DLOOP	AND R5, R5, x0		;CLEARS R5
	ADD R4, R4, #1
	ADD R5, R3, x0		;R3 INTO R5
	ADD R3, R3, R2
	BRzp DLOOP
	ADD R4, R4, #-1
	RET
